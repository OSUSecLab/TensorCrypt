...
def ofb_mode_test():
    ...
    csv_path = f"data/ofb_cpu_time.csv"
    with open(csv_path, 'a+') as f:
        print("---- Current time:", cur_time, "----", file=f)
        print("block_num,key_expansion,model_load_time,first_time_sec,load_plaintext_tensor,CPU_and_retrieval_time", file=f)
    ...
    for k, i in enumerate(np.logspace(1, 8, num=15, dtype='int')):
        ...
        num_iter = 10
        start_time = time.time()
        res = cipher(iv, p, round_keys, length)
