...
class Cipher(tf.Module):
    ...
    def __call__(self, counter, plaintext, round_keys):
        Nr = 10
        sbox = [
        ...
        # counter = tf.cast(counter, dtype=tf.int32)
...
def inference():
    ...
    res = cipher(counter, plaintext, round_keys)
...
def validate_correctness():
    ...
    counter = tf.constant(counter, dtype=tf.int32, shape=(block_num, 16))
