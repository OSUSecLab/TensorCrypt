...
from ctr_ciphter_counter_outside import Cipher
import sys
...
def ctr_mode_test():
    ...
    csv_path = f"data/ctr_outside_parallel_inference_time_{cur_time}.csv"
    ...
    for k, i in enumerate(np.logspace(1, 8, num=15, dtype='int')):
        ...
        average_time = total_time / (num_iter-1)
        with open(csv_path, 'a+') as f:
